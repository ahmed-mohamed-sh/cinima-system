  ...
  return show ? (
    <div className="mt-32 flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-10">
        ...
        <div className="relative flex-1 flex flex-col items-center max-md:mt-16">
            ...
            <button onClick={() => navigate("/my-bookings")} className="mt-10 flex items-center gap-1 px-6 py-3 bg-[#F84565] hover:bg-[#F84565]/80 transition text-sm rounded-full font-medium cursor-pointer">
  proceed to checkout
