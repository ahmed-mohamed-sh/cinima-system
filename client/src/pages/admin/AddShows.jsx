...
import { kConvorter } from "../../lib/kConvorter";
...
const AddShows = () => {
    ...
    const [dateTimeSelection, setSelectedTimeSelection] = useState({});
              ...
              <div key={movie.id} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300`} onClick={() => setSelectedMovie(movie.id)}>
                <div className="relative rounded-lg overflow-hidden">
                  ...
                  <div className="text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0">
                      ...
                      <p className="text-gray-300">{kConvorter(movie.vote_count)} Votes</p>
                  </div>
                </div>
  ...
  <div className="inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md bg-transparent">
...
<div className="mt-6">
  ...
  <div className="inline-flex gap-5 border border-gray-500 p-1 pl-3 rounded-lg bg-transparent">
    <input 
      type="datetime-local" 
      value={dateTimeInput} 
    ...
    <button 
      ...
      className="bg-[#F84565]/80 text-white px-3 py-2 text-sm rounded-lg hover:bg-[#F84565] cursor-pointer"
    >
      Add Time
    </button>
  </div>
